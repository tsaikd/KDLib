...
public:
	CKDSQLiteField() {}
	CKDSQLiteField(LPCTSTR lpName, LPCTSTR lpType = _T("TEXT")) { m_sName = lpName; m_sType = lpType; }
...
public:
	...
	inline void AddField(LPCTSTR lpName, LPCTSTR lpType = _T("TEXT")) { m_aField.Add(CKDSQLiteField(lpName, lpType)); }
